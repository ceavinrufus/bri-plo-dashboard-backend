...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\NodinIpPengadaan>
 */
class NodinIpPengadaanFactory extends Factory
{
    protected $model = NodinIpPengadaan::class;
